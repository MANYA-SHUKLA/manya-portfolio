...
function ProjectPanel() {
  ...
  tags: ["MongoDB", "Express.js", "React.js", "Node.js", "JWT"]
     ...
     {
  title: "IELTSPro - Frontend",
  description: "A professional, responsive IELTS Institute landing page built with Next.js, TypeScript, and Tailwind CSS featuring a clean UI, Hero section, features, testimonials, and footer.",
  live: "https://ielts-pro-frontend.vercel.app/",
  image: "https://ieltspro.live/wp-content/uploads/2024/01/Group-1234-1024x661.png",
  tags: ["Next.js", "Typescript", "Tailwind CSS", "Framer Motion"]
},
  {
